...
<body>
  <div class="app">
    <div>
      ...
      <p class="hint">App-shell mode keeps the top URL at localhost:8888 while browsing in-frame.</p>
      <p class="hint">Local-only hardening is best-effort; it does not guarantee full anonymity.</p>
    </div>
...
def main():
    ...
    print(
        f"""
╔═══════════════════════════════════════════════════════════════╗
║                Local Proxy Shell Started                      ║
╠═══════════════════════════════════════════════════════════════╣
║ URL: http://localhost:{PORT:<5}                                   ║
║ DuckDuckGo is used as default search behavior.                ║
╚═══════════════════════════════════════════════════════════════╝
"""
    )
    try:
